/**
 * Tag-Based Report Component (Admin View)
 * 
 * Displays performance of learners grouped by tags.
 * Similar to trainer view but shows all learners, not just assigned ones.
 */
...
class AdminTagBasedReport {
    ...
    async init() {
        try {
            console.log('[AdminTagBasedReport] Initializing...');
            ...
            console.error('[AdminTagBasedReport] Error initializing:', error);
    ...
    async loadTags() {
        try {
            ...
            console.warn('[AdminTagBasedReport] Error loading tags:', error);
            this.tags = [];
        }
    }
            ...
            <div class="report-container">
                <div class="report-header">
                    ...
                    <div class="report-actions">
                        ${exportOptions.render(this.reportData, 'admin_tag_based_report')}
                    </div>
                </div>
                    ...
                    <div class="tag-selector-card">
                        ...
                        ${this.tags.length === 0 ? `
                            <div class="no-tags-message">
                                <p>No tags available. <a href="#/reports/admin/tags">Create tags</a> to start analyzing performance.</p>
                            </div>
                        ` : `
    ...
    async loadReport() {
        try {
            ...
            this.container.querySelector('.tag-report-results')?.remove();
            this.container.insertAdjacentHTML('beforeend', '<div class="report-loading">Loading...</div>');
            ...
            const loadingDiv = this.container.querySelector('.report-loading');
            if (loadingDiv) {
                loadingDiv.remove();
            }

            const resultsHtml = this.renderReportData();
            this.container.insertAdjacentHTML('beforeend', resultsHtml);
        } catch (error) {
            console.error('[AdminTagBasedReport] Error loading report:', error);
...
export default AdminTagBasedReport;
