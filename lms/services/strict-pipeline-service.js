    ...
    async processQueryStrict(question, courseId, userId, options = {}) {
        ...
        try {
            ...
            if (queryCategory === 'unrelated') {
                console.log('[StrictPipeline] Unrelated query detected');
                return {
                    success: true,  // Return success=true so UI displays the message properly
                    answer: "This question is outside the scope of this course.",
                    references: [],
                    confidence: 0.0,
                    source: 'unrelated_query',
                    has_references: false,
                    query_category: 'unrelated'
                };
            }
            
            // Handle non-content queries - AI Coach is not designed for these
            if (queryCategory === 'structural') {
                console.log('[StrictPipeline] Structural query - not supported');
                return {
                    success: true,  // Return success=true so UI displays the message properly
                    answer: "I am not designed to handle Structural queries. Please contact your trainer for information about course structure.",
                    references: [],
                    confidence: 0.0,
                    source: 'unsupported_query_type',
                    has_references: false,
            ...
            if (queryCategory === 'navigation') {
                console.log('[StrictPipeline] Navigation query - not supported');
                return {
                    success: true,  // Return success=true so UI displays the message properly
                    answer: "I am not designed to handle Navigation queries. Please contact your trainer for guidance on course navigation.",
                    references: [],
                    confidence: 0.0,
                    source: 'unsupported_query_type',
                    has_references: false,
            ...
            if (queryCategory === 'planning') {
                console.log('[StrictPipeline] Planning query - not supported');
                return {
                    success: true,  // Return success=true so UI displays the message properly
                    answer: "I am not designed to handle Planning queries. Please contact your trainer for help with course planning.",
                    references: [],
                    confidence: 0.0,
                    source: 'unsupported_query_type',
                    has_references: false,
            ...
            if (queryCategory === 'lab_guidance') {
                console.log('[StrictPipeline] Lab guidance query - not supported');
                return {
                    success: true,  // Return success=true so UI displays the message properly
                    answer: "I am not designed to handle Lab Guidance queries. Please contact your trainer for help with labs and assignments.",
                    references: [],
                    confidence: 0.0,
                    source: 'unsupported_query_type',
                    has_references: false,
